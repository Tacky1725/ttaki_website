...
const translations = {
  ja: {
    ...
    works_title: '制作物',
    works_intro: '個人やチームで制作した代表的な作品を掲載しています。',
    ...
    nsc_lead: '旅先の写真で日本地図を完成させる、新しい思い出の残し方',
    nsc_intro: '都道府県ごとに写真を1枚登録すると、地図のピースが埋まります。写真に撮影日・場所・コメントを残しながら日本地図を完成させる、思い出記録アプリです。',
    ...
    train_lead: 'ストレスいっぱいの満員電車の中で、力を解放してすべてを吹き飛ばす',
    train_intro: 'VR映像に振動・風圧・圧迫感などの感覚演出を加え、満員電車の過酷な環境を再現。体験者は腕に力を込めてエネルギーを蓄積・解放し、周囲のものを吹き飛ばすことで、ストレス解消の爽快感を味わいます。',
    train_reflection: '本作品はVR作品コンテスト「Interverse Virtual Reality Challenge」出展作品です。',
    ...
    train_point2_text: 'マルチコア処理で振動・送風制御を分離し、単一のマイコン上で遅延なく同時実行。複数の家庭用サーキュレータをリレー制御し、稼働台数と組み合わせによってゲーム画面に合わせた走行風や衝撃波を安全かつ低コストに表現しました。',
  ...
  en: {
    ...
    works_intro: 'Selected works created individually and as part of teams.',
    ...
    train_reflection: 'This project was exhibited at the Interverse Virtual Reality Challenge, a competition for VR works.',
