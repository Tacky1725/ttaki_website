...
const translations = {
  ja: {
    ...
    train_point1_title: '2自由度ジョイントによるリアルな電車の揺れの提示',
    train_point1_text: '2本のアクチュエータと回転軸を、前後方向の傾斜可動域と角加速度・角速度を大きく確保できるよう配置。さらに、ポテンショメータの非線形特性を実測データから近似して補正し、急発進・急停車を含む電車特有の揺れを高精度に提示しました。',
    train_point2_title: '振動・送風のリアルタイム同時制御',
    train_point2_text: 'マルチコア処理で通信・振動・送風制御を分離し、単一のマイコン上で遅延なく同時実行。複数の家庭用サーキュレータをリレー制御し、稼働台数と組み合わせによって走行風や衝撃波を安全かつ低コストに表現しました。',
  ...
  en: {
    ...
    works_intro: 'Selected personal and team projects spanning application development and immersive experiences.',
    ...
    train_lead: 'A VR experience where you unleash your power and blast passengers out of a multisensory crowded train.',
    train_intro: 'The harsh environment of a crowded train is recreated through VR visuals, vibration, pressure, scent, and other sensory effects. Players build and release energy with their bodies, sending nearby passengers flying and experiencing an exhilarating release from stress.',
    train_reflection: 'For the Interverse Virtual Reality Challenge, I helped develop an interactive work using fans and a tilting platform. Developing the work and experiencing many competing projects showed me how strongly integrated sensory cues can deepen immersion. Adding touch transforms a virtual world from something merely observed into something experienced through the body.',
    train_engineering_title: 'Engineering highlights',
    train_point1_title: 'Realistic train motion using a two-axis joint',
    train_point1_text: 'Two actuators and a pivot were positioned to maximize forward–backward tilt range, angular acceleration, and velocity. A data-derived correction for the potentiometer’s nonlinear response enables precise recreation of train motion, including sudden starts and stops.',
    train_point2_title: 'Real-time vibration and airflow control',
    train_point2_text: 'Multicore processing separates communication, vibration, and airflow control for low-latency execution on one microcontroller. Relay-controlled household fans reproduce running wind and shock waves through different unit combinations safely and affordably.',
    watch_pv: 'Promotional video <span class="icon-inline material-symbols-rounded" aria-hidden="true">open_in_new</span>',
    watch_explanation: 'Behind-the-scenes video <span class="icon-inline material-symbols-rounded" aria-hidden="true">open_in_new</span>',
    vocab_coming_soon: 'Details about this custom English vocabulary app will be added soon.',
    about_title: 'About',
