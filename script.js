...
const i18n = {
  ja: {
    ...
    hero_sub: "Mixed Reality × 自律移動ロボットの地図編集インタフェースを研究しています。",
    ...
    profile_brief_item2: "2021年4月 - 2025年3月：大阪大学 情報科学研究科 ソフトウェア科学コース",
    pub_title: "研究業績",
  ...
  en: {
    ...
    nav_contact: "Contact",
    hero_title: "Takumi TAKI | 多喜 匠",
    hero_sub: "I research a Mixed Reality–based map editing interface for autonomous mobile robots.",
    ...
    profile_brief_item2: "Apr 2021 – Mar 2025: Course in Software Science, Graduate School of Information Science and Technology, The University of Osaka",
